...
class Radial_Invoicing_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function __construct()
    {
        $this->config = Mage::getModel('radial_core/config_registry')
            ->setStore(null)
            ->addConfigModel(Mage::getSingleton('radial_invoicing/config'));
    }
    ...
    public function setOrderReadyToShip(Mage_Sales_Model_Order $order)
    {
        $order->setState(
            ...
            Radial_Invoicing_Model_Order::STATUS_READY_CODE
        )->save();
        return $this;
    }
